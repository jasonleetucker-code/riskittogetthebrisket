...
**V1 completion: 72 / 136 = 52.9%.** (70 on `main` post-`#1024`(`V1-94`)/`#1029`(`V1-46`) + `V1-69`/`V1-90` here, each `NOT STARTED` → `VERIFIED`. `V1-121` was corrected back to `NOT STARTED` on 2026-08-21 per owner comment — see its row note — so this branch promotes two rows, not three.)
