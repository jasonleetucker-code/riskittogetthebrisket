...
**V1 completion: 71 / 136 = 52.2%.** (69 on `main` post-`#1014`/`#1026`/`#1024`(`V1-94`) + `V1-69`/`V1-90` here, each `NOT STARTED` → `VERIFIED`. `V1-121` was corrected back to `NOT STARTED` on 2026-08-21 per owner comment — see its row note — so this branch now promotes two rows, not three.)
