...
**Implementation architecture:** `docs/autonomy/SITE_STEWARD_ARCHITECTURE_2026-09-08.md`  
**Machine-readable proposed contracts:** `config/steward/contracts.schema.json`
