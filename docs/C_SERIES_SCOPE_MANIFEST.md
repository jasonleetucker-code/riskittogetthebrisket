...
| id | capability | owner | status | final | disposition | deps | source | prof | lane | flag | evidence |
|---|---|---|---|---|---|---|---|---|---|---|---|
| `C7-BEST-TRADE` | **Best Trade to Send Each Team** | `C3-PKG-01` + `C3-CON-01` + `C3-XMKT-01` | ABSENT — zero hits repo-wide | Exactly one qualifying trade per opponent; players only; equal counts; no picks; canonical WIN for us; opponent EVEN-or-better on KTC **or** IDPTC with whole-package native coverage; **no imputed approval**; honest no-result; ranked for mutual defensibility, not maximum exploit; recommendation only | IMPLEMENT | `C3-PKG-01`, `C3-CON-01`, `C3-XMKT-01`, `C2-STR-01` | #835 §1, ledger 102 | P1 | decide | see below | 11 hard rules tested |
