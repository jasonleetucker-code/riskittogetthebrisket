...
| `C2-U1` | (stacked on #879) | see PR | local: full backend suite green, 2,037 frontend, 90 lineup tests; board measured inert **0/1111 values, 0 ranks**; confidence measured inert **0/1111 rows**; ruff, coercion, planning and structural-contract gates clean. The canonical solver was independently verified against **Sleeper's own awarded lineups, 10/10**, before being trusted | `C2-U2` · `C2-U3` · `C2-U4` · `C2-U6` · `C2-U9` · `C5-PLAY-01` — the root of the C2 phase | pending — checklist in `docs/lineup/C2_U1_CANONICAL_LINEUP.md` §10 |
