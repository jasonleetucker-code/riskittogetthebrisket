...
## A3. Starter relevance filter (CE-13)
...
## A5. League longevity / history (CE-02)
...
## A6. Comparable-user strategy signals (CE-12)
...
## B2. Trade-tax / friction constraints (CE-05 lineage)
...
## B6. Future picks as trade assets (CE-04)
...
Do not build an independent CE-04 pick-value model.

## B7. Cross-league trade / portfolio view (CE-10)
...
## B8. League keeper / privacy mechanics (CE-11)
...
## E5. Individualized rankings / tuning (CE-14)
...
## E6. User feedback / polling (CE-14A)
...
## F3. Personalized campaign/feed (CE-20 lineage)
