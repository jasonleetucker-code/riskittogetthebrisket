...
| Canonical-owner consolidation | #843 | Roster Capacity / forced-drop economics | Consolidate duplicate roster-capacity/droppability ownership before further extension; preserve forced-drop/open-slot economics through one canonical owner. | PARTIAL / OWNER DECISION REQUIRED |
