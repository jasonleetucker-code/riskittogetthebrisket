...
| Planned source / owner-approved addition | #801 | Rankings / Establish The Run | Add Establish The Run's dynasty rankings to the canonical source-data system after the exact format and authorized acquisition path are approved. Research must distinguish ETR's dynasty rankings from its redraft Half-PPR/Full-PPR/2-QB/6-point-pass-TD boards, prevent duplicate ETR lineage, preserve format/provenance, and validate board impact before production weighting. | PLANNED |
...
42. **Establish The Run is an approved planned ranking source, but format selection and acquisition are gated:** add ETR dynasty rankings to canonical source data after owner review of the research recommendation and a permitted/stable acquisition path. Do not treat ETR's redraft PPR/2-QB/6-point-pass-TD boards as independent dynasty votes merely because their scoring labels resemble league settings, and do not double-count ETR lineage across variants.
...
Do not mix these unrelated UI/auth/product requirements into the currently isolated B4 percentile-tail repair. Immediate defects (#779-#781) should be picked up at the next safe product-hotfix checkpoint unless one blocks required verification. #782-#786 are approved scope but must enter their natural dependency checkpoints rather than interrupt B4. CE-20/#789 must enter the master dependency plan and should begin only after scoring correctness, canonical best-ball assignment, projection-source/custom-stat modeling and prediction-history foundations are ready. #790 should be audited at the next appropriate trade/model checkpoint; #791 is a small UX addition but should still avoid interrupting B4; #792 is dependency-gated until canonical value/package/Team Strength/Weakness/roster-impact foundations are trustworthy. #800 is a trade-correctness defect and should be handled at the next safe Trade Calculator checkpoint; #801 is a planned ranking-source addition whose acquisition/format decision must be owner-approved before implementation. CE-17–CE-21 remain future competitive expansion after their dependencies. #788 stays long-term/cost-gated.