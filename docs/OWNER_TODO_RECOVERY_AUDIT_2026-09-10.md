...
| R-53 | 2026-08-14 | Canonical Roster Capacity / forced-drop economics | #843 | **PARTIAL; canonical-owner consolidation SHIPPED 2026-08-18** (`src/trade/roster_capacity.py`, one owner consumed by `simulate_trade`/`suggestions.py`/`finder.py`/both `angle.py` endpoints); remaining scope is the Analyze Trade (#792) integration, dependency-gated — status corrected against current `main` at PR #1339 time, superseding this audit's original "consolidation required" reading | **No direct row** |
