...
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `/design` | C8-U2/U3 | Static gallery / ds/token-contract.js; no private API | STABLE foundation | MIGRATING — existing PSI scope applied; proof pending | Code inspected; NV | Parity NV | Existing suite; route NV | NM | Retirement not re-certified | No fresh production screenshots | #1422 implementation branch | Governance contract / gallery claim | Apply existing PSI scope including portals; fixtures/display roles; responsive/axe/screenshots |
