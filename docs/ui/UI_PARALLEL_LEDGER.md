...
reference unit, now draft PR #1429 with measured CI evidence. #1428 holds only chart-treatment acceptance; no deployment or continuously running worker is claimed.
...
| `/gameday` | C9 + C8-U2 | GameDayPanel / canonical matchup and season contracts | CONDITIONAL by feature | AUDITED — Legacy/partial; #1335 hierarchy remains | Code inspected; NV | Parity NV | Existing suite; route NV | NM | Retirement not re-certified | No fresh production screenshots | No new UI writer confirmed | Selected team / exact best-ball projection | Matchup/verdict/slate first, deep details disclosed; do not invent visual direction |
