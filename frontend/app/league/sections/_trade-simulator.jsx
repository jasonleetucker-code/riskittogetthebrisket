...
// Python is the source of truth (and what /api/draft-capital stamps for
// the static chart).  This mirror exists ONLY so the simulator can
// recompute the zero-sum, field-relative lens for a *hypothetical*
// post-trade field locally.  Keep the math and constants in lockstep
// with effective_auction_power(); see that module's docstring for the
// economic rationale (S-curve premium, saturating, zero-sum).
const AP_PREMIUM_GAIN = 0.35;
const AP_CURVATURE = 1.25;
const AP_LEAPFROG_WEIGHT = 0.15;
...
function _roundPreservingTotal(values, total) {
...
function effectiveAuctionPower(totalsObj) {
  ...
  const rounded = _roundPreservingTotal(scaled, grand);
