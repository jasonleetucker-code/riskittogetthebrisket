...
// ── Contender / rebuilder tiers — MOVED ────────────────────────────────
//
// `scoreTeamTiers` was deleted in the W20-F006/F007 classifier
// consolidation: it was the second of four team-direction models and
// its forced-tercile ladder contradicted the power table 400px above it
// on /rosters. The starter / depth / pick SPLIT it produced survives in
// `lib/team-phase.js::analyzeLeaguePhases`, and the regression pins for
// the math audit's H5(a) — pick capital counted twice, once as depth at
// +0.2 and once as a "penalty" at −0.1, for a NET +0.1 reward — moved
// with it to `frontend/__tests__/team-phase.test.js`.
