...
ROS_SOURCES: tuple[dict[str, Any], ...] = (
    ...
    # ── PR 5 adapters ────────────────────────────────────────────────
    {
        ...
        "display_name": "FantasyPros Dynasty IDP (ROS proxy)",
        "source_url": "https://www.fantasypros.com/nfl/rankings/dynasty-idp.php",
        "source_type": "dynasty_proxy",
        "scoring_format": "ppr",
        "is_superflex": False,
        "is_2qb": False,
    ...
    },
    {
        ...
        "source_url": "https://fantasyfootballcalculator.com/adp/2qb",
        "source_type": "adp",
        "scoring_format": "ppr",
        "is_superflex": False,
        "is_2qb": True,
        ...
        "base_weight": 0.70,
        "stale_after_hours": 24,
        "scraper": "src.ros.sources.fantasy_football_calculator",
        "enabled": True,
    },
)
