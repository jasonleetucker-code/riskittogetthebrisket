#!/usr/bin/env bash
# Model-neutral session-start health check for Risk It To Get The Brisket
# Canonical startup/preflight for Claude, Codex, Gemini, ChatGPT, Copilot, and future coding agents.
# Claude's .claude/health-check.sh is only an adapter to this shared script.
...
# output short and deterministic: point every agent at the canonical operating
