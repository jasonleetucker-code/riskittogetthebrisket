...
class TestGate8FlagIntegrity(unittest.TestCase):
    ...
    def test_confidence_distribution_reasonable(self):
        ...
        Relaxed to 10% after 2026 slot picks were pulled out of the
        ranked board (they were anchored high-confidence rows;
        removing them drops the high-count while the medium/low
        distribution among players is unchanged).  Relaxed again from
