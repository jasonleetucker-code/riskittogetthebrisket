...
def _make_player(name, position, *, ktc=None, idp=None, team="TST", sleeper_id=None):
    ...
    if ktc is not None:
        ...
        # ``ktcCrowdSfTep`` is the canonical KTC offense source.  The
        ...
        rows = [
            {
                ...
                "assetClass": "offense",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 7000},
                "anomalyFlags": [],
        ...
        rows = [
            {
                ...
                "assetClass": "offense",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 9000},
                "anomalyFlags": [],
        ...
        rows = [
            {
                ...
                "assetClass": "offense",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 8000},
                "anomalyFlags": [],
                "confidenceBucket": "low",
                "confidenceLabel": "",
        ...
        rows = [
            {
                ...
                "assetClass": "offense",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 1000},
                "anomalyFlags": [],
...
class TestIdentityConfidence(unittest.TestCase):
    ...
    def test_partial_evidence_gives_0_85(self):
        ...
        row = {
            ...
            "position": "LB",
            "assetClass": "idp",
            "canonicalSiteValues": {"ktcCrowdSfTep": 5000},
        }
        score, method = _compute_identity_confidence(row)
        ...
        rows = [
            {
                ...
                "assetClass": "offense",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 4200},
                "anomalyFlags": [],
                "confidenceBucket": "low",
                "confidenceLabel": "",
            ...
            },
            {
                ...
                "assetClass": "idp",
                "playerId": None,
                "canonicalSiteValues": {"ktcCrowdSfTep": 685},
                "anomalyFlags": [],
                "confidenceBucket": "low",
                "confidenceLabel": "",
...
class TestSleeperMapCollisionGuardrail(unittest.TestCase):
    ...
    def test_signals_on_both_sides_keep_sleeper_position(self):
        ...
        row, _ = self._build_row(
            sleeper_pos="DB",
            sites={"ktcCrowdSfTep": 3000, "idpTradeCalc": 3000},
        )
        self.assertIsNotNone(row)
        ...
        rows = [
            {
                ...
                "canonicalSiteValues": {"ktcCrowdSfTep": 3000, "footballGuysSf": 2800},
            },
        ]
    ...
    def test_post_enrichment_preserves_correctly_tagged_row(self):
        ...
        rows = [
            ...
            },
            {
                ...
                "canonicalSiteValues": {"ktcCrowdSfTep": 4500},
            },
        ]
        _strip_mismatched_family_tags(rows)
