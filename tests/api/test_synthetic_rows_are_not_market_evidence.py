...
def _board():
    ...
    """
    return [
        _row("Alpha QB", "QB", "offense", idpTradeCalc=9000, ktcCrowdSfTep=9000),
        _row("Beta WR", "WR", "offense", idpTradeCalc=7000, ktcCrowdSfTep=7000),
        ...
        _row("2027 Early 1st", "PICK", "pick", idpTradeCalc=5000, ktcCrowdSfTep=5000),
        # The derived one — a value we computed, published under the
        # vendors' keys so the row can be blended.
        _row("2029 Early 1st", "PICK", "pick", idpTradeCalc=3600, ktcCrowdSfTep=3600),
    ]
