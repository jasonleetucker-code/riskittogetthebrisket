"""Trade CONSUMES the Roster owners; it does not recreate them.

This file is the executable proof that C3-CAP-01 consumes the C2 roster
chain rather than reimplementing it.  It is deliberately **not** skipped and not marked ``livedata``:
...
``scripts/prove_trade_consumes_roster.py``, which mutates the
